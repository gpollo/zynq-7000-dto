...
#
# setup_project.tcl: Tcl script for re-creating project 'vivado'
#
# Generated by Vivado on Sun May 08 10:55:12 EDT 2022
...
#
# 1. This project restoration tcl script (setup_project.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/axi_int_test"]"]"\
  ]
  foreach ipath $paths {
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../Downloads/bdf"]" -objects $obj
...
set_property -name "platform.board_id" -value "minized" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/axi_int_test"]" $obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "toplevel_basic_wrapper" -objects $obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "toplevel_axi_wrapper" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Proc to create BD toplevel_basic
proc cr_bd_toplevel_basic { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name toplevel_basic
...
Flash#Quad SPI Flash#USB Reset#Quad SPI Flash#GPIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD\
...
0#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#Unbonded#UART\
1#UART 1#Unbonded#Unbonded#GPIO#GPIO}\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-380,-176",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 990 -y 270 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 990 -y 300 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 220 -y 360 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 590 -y 140 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 220 -y 120 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 860 -y 160 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 10 420 270 740J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 20 410
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 440 260 750
preplace netloc processing_system7_0_DDR 1 1 3 NJ 280 750J 270 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 300 NJ 300 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 430 80n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 140
levelinfo -pg 1 0 220 590 860 990
pagesize -pg 1 -db -bbox -sgen 0 0 1100 520
"
}
...
# End of cr_bd_toplevel_basic()
cr_bd_toplevel_basic ""
set_property REGISTERED_WITH_MANAGER "1" [get_files toplevel_basic.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files toplevel_basic.bd ] 
set_property USED_IN "synthesis implementation" [get_files toplevel_basic.bd ] 
set_property USED_IN_SIMULATION "0" [get_files toplevel_basic.bd ] 



# Proc to create BD toplevel_axi
proc cr_bd_toplevel_axi { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name toplevel_axi
  ...
  if { $bCheckIPs == 1 } {
     set list_check_ips "\ 
  example.com:user:axi_int_test:1.1\
  xilinx.com:ip:processing_system7:5.5\
  xilinx.com:ip:proc_sys_reset:5.0\
  ...
  # Create instance: axi_int_test_0, and set properties
  set axi_int_test_0 [ create_bd_cell -type ip -vlnv example.com:user:axi_int_test:1.1 axi_int_test_0 ]

  # Create instance: axi_int_test_1, and set properties
  set axi_int_test_1 [ create_bd_cell -type ip -vlnv example.com:user:axi_int_test:1.1 axi_int_test_1 ]
...
1#UART 1#Unbonded#Unbonded#GPIO#GPIO}\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_int_test_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_int_test_1/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins axi_int_test_0/S_AXI_ACLK] [get_bd_pins axi_int_test_1/S_AXI_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net axi_int_test_0_INTERRUPT [get_bd_pins axi_int_test_0/INTERRUPT] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_int_test_1_INTERRUPT [get_bd_pins axi_int_test_1/INTERRUPT] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_int_test_0/S_AXI_ARESETN] [get_bd_pins axi_int_test_1/S_AXI_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_int_test_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_int_test_1/S_AXI/reg0] -force
...
# End of cr_bd_toplevel_axi()
cr_bd_toplevel_axi ""
set_property REGISTERED_WITH_MANAGER "1" [get_files toplevel_axi.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files toplevel_axi.bd ] 
set_property USED_IN "synthesis implementation" [get_files toplevel_axi.bd ] 
set_property USED_IN_SIMULATION "0" [get_files toplevel_axi.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse toplevel_basic.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vivado/vivado.gen/sources_1/bd/toplevel_basic/hdl/toplevel_basic_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse toplevel_basic.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

if { [get_property IS_LOCKED [ get_files -norecurse toplevel_axi.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/vivado/vivado.gen/sources_1/bd/toplevel_axi/hdl/toplevel_axi_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse toplevel_axi.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z007sclg225-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z007sclg225-1 -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
